...
setErrorCardVisible(true)
  ...
  return (
    <form className="Add-New-Supp-Form">
     ...
     <MyInput input_v={supplierData.name} onChange={handleNameChange} label_v={"اسم المورد"}></MyInput>
     <MyInput input_v={supplierData.phone_number} onChange={handlePhoneNumberChange} label_v={"رقم الهاتف"}></MyInput>
     <MyInput input_v={supplierData.warehouse_name} onChange={handleWarehouse_nameChange} label_v={"اسم المسنودع"}></MyInput>
     <MyTextarea data_v={supplierData.location} onChange={handleLocationChange} label_v={"العنوان"}></MyTextarea>
