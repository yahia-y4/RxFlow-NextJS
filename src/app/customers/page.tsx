...
export default function Customers() {
  ...
  return (
    <div className="Customers-page">
      <CustomersForm />
      {!CustomerPaymentsReceivedListVisible && !CustomerDebtsListVisible && (
        <CustomersList />
      )}
      {CustomersInfoVisible && <CustomersInfo />}
      {CustomersInfoVisible && CustomerDebtsListVisible && (
        <CustomerDebtsList />
      )}
      {CustomersInfoVisible && CustomerPaymentsReceivedListVisible && (
