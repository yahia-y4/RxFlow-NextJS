  ...
  return (
    <div className="general-statistics">
      ...
      <div className="general-statistics-info-cards">
        <InfoCard
          description="عدد الادوية في المخزن"
          value={statisticsItems?.total_items_in_storage}
        />
        <InfoCard
          description="عدد القطع في المخزن"
          value={statisticsItems?.total_quantity_in_storage}
        />
        <InfoCard
        ...
        <InfoCard
          ...
          value={statisticsItems?.total_out_quantity}
        />
        <InfoCard
          description="عدد الزبائن"
          value={statisticsCustomers?.total_count_Customers}
        />
        <InfoCard
          description="عدد الزبائن المدينين"
          value={statisticsCustomers?.count_Customers_with_debts}
        />
        <InfoCard
          description="عدد الزبائن غير المدينين"
          value={statisticsCustomers?.count_Customers_without_debts}
        />
        <InfoCard
        ...
        <InfoCard
          ...
          value={statisticsSuppliers?.total_count_Suppliers}
        />
        <InfoCard
          description="عدد الموردين ذوي المستحقات"
          value={statisticsSuppliers?.count_Suppliers_with_payable_amount}
        />
        <InfoCard
          description="عدد الموردين معدومي المستحقات"
          value={statisticsSuppliers?.count_Suppliers_without_payable_amount}
        />
        <InfoCard
